...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        while True:
            ...
            img_path = '/home/nilim/Documents/programmer/backup/dataset/gazi/ 2.jpg'
                        ...
                        if best_class_probabilities>0.53:
                            ...
                            for H_i in HumanNames:
                                if HumanNames[best_class_indices[0]] == H_i:
                                    result_names = "{}: {:.2f}%".format(HumanNames[best_class_indices[0]], best_class_probabilities[0] * 100 )
